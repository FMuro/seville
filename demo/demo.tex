...
\begin{frame}
    ...
    Math fonts can be bold $\symbf{ABC}$, blackboard bold $\mathbb{ABC}$, caligraphic $\mathcal{ABC}$, and fraktur $\mathfrak{ABC}$. We also have Greek versions $\Alpha\Beta\Gamma$, $\symbf{\Alpha\Beta\Gamma}$,$\alpha\beta\gamma$, $\symbf{\alpha\beta\gamma}$.
